...
def run(config, plugins):  # pylint: disable=too-many-branches,too-many-locals
    ...
    logger.info('Plugins used: Authenticator: {0}; Installer: {1}'.format(authenticator.__class__,
        installer.__class__))
...
def renew_cert(config, plugins, lineage):
    ...
    logger.info('Plugins used: Authenticator: {0}; Installer: {1}'.format(auth.__class__,
        installer.__class__))
